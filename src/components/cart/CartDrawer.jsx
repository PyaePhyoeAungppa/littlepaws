...
export default function CartDrawer({ open: externalOpen, onOpenChange: externalOnOpenChange, hideTrigger } = {}) {
                    ...
                    <AnimatePresence mode="wait">
                        {items.length === 0 ? (
                            <motion.div
                                ...
                                exit={{ opacity: 0, scale: 0.95, y: -10, transition: { duration: 0.3, ease: 'easeInOut' } }}
                            ...
                            >
                                ...
                                <Button onClick={() => { setOpen(false); setTimeout(() => navigate('/marketplace'), 300); }} className="rounded-full px-6" variant="outline">
                                    Go Shopping →
                                </Button>
                            </motion.div>
                        ) : (
                ...
                {items.length > 0 && (
                    <div className="px-6 pt-4 pb-8 border-t bg-white space-y-4">
                        ...
                        <Button
                            ...
                            onClick={() => { setOpen(false); setTimeout(() => navigate('/checkout'), 300); }}
                        >
